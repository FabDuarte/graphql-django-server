    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='starwars.Planet')),
        ...
        migrations.AddField(
            model_name='hero',
            name='homeworld',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heroes', to='starwars.Planet'),
        ),
        migrations.AddField(
            model_name='film',
            name='characters',
            field=models.ManyToManyField(blank=True, related_name='films', to='starwars.People'),
        ),
        migrations.AddField(
            model_name='film',
            name='planets',
        ...
        migrations.AddField(
            model_name='film',
            name='species',
            field=models.ManyToManyField(blank=True, related_name='films', to='starwars.Species'),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='pilots',
            field=models.ManyToManyField(blank=True, related_name='vehicles', to='starwars.People'),
        ),
        migrations.AddField(
            model_name='starship',
            name='pilots',
            field=models.ManyToManyField(blank=True, related_name='starships', to='starwars.People'),
        ),
        migrations.AddField(
            model_name='film',
            name='starships',
            field=models.ManyToManyField(blank=True, related_name='films', to='starwars.Starship'),
        ),
        migrations.AddField(
            model_name='film',
            name='vehicles',
            field=models.ManyToManyField(blank=True, related_name='films', to='starwars.Vehicle'),
        ),
    ]
